 ...
 */
export async function sendPushNotificationToUser(userId, title, body, data, env) {
    try {
        ...
        await db
            ...
            .where(and(eq(pushTokens.userId, userId), eq(pushTokens.isActive, true)));
        console.log(`✅ Push notification sent to ${expoPushTokens.length} devices for user ${userId}`);
 ...
 */
export async function sendPaymentReceivedNotification(userId, amount, currency = "JMD", senderName, env) {
    ...
    if (senderName) {
        try {
            ...
            console.warn("Warning: Could not fetch user for notification comparison:", error);
    ...
    return sendPushNotificationToUser(userId, title, body, {
 ...
 */
export async function sendPayoutProcessedNotification(userId, amount, currency = "JMD", env) {
 ...
 */
export async function sendTransactionFailedNotification(userId, reason = "Transaction failed", env) {
 ...
 */
export async function sendWelcomeNotification(userId, userName, env) {
